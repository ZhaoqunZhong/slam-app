...
namespace Initializer {
    ...
    typedef void (*initial_result_callback)(std::vector<double> &ts_,
                                            std::vector<Eigen::Vector3d> &Ps_,
                                            std::vector<Eigen::Vector3d> &Vs_,
                                            std::vector<Eigen::Matrix3d> &Qs_, Eigen::Vector3d ba_,
                                            Eigen::Vector3d g, Eigen::Vector3d bg_,
                                            std::vector<shared_ptr<IntegrationBase>> &pre_integrations_,
    ...
    public:
        ...
        // interface
        void
        processIMU(double t, const Vector3d &linear_acceleration, const Vector3d &angular_velocity);

        bool processImage(const map<int, vector<pair<int, Eigen::Matrix<double, 7, 1>>>> &image,
                          const double header);
