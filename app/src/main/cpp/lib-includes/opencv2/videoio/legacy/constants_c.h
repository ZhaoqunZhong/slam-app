...
enum
{
    ...
    CV_CAP_PROP_AUTO_EXPOSURE =21, // rgb_exposure control done by camera,
    ...
    CV_CAP_PROP_XI_AEAG                                         = 415, // Automatic rgb_exposure/gain
    CV_CAP_PROP_XI_EXP_PRIORITY                                 = 416, // Exposure priority (0.5 - rgb_exposure 50%, gain 50%).
    CV_CAP_PROP_XI_AE_MAX_LIMIT                                 = 417, // Maximum limit of rgb_exposure in AEAG procedure
    CV_CAP_PROP_XI_AG_MAX_LIMIT                                 = 418,  // Maximum limit of gain in AEAG procedure
    CV_CAP_PROP_XI_AEAG_LEVEL                                   = 419, // Average intensity of output signal AEAG should achieve(in %)
    CV_CAP_PROP_XI_TIMEOUT                                      = 420, // Image capture timeout in milliseconds
    CV_CAP_PROP_XI_EXPOSURE                                     = 421, // Exposure time in microseconds
    CV_CAP_PROP_XI_EXPOSURE_BURST_COUNT                         = 422, // Sets the number of times of rgb_exposure in one frame.
    ...
    CV_CAP_PROP_XI_AEAG_ROI_OFFSET_X                            = 439, // Automatic rgb_exposure/gain ROI offset X
    CV_CAP_PROP_XI_AEAG_ROI_OFFSET_Y                            = 440, // Automatic rgb_exposure/gain ROI offset Y
    CV_CAP_PROP_XI_AEAG_ROI_WIDTH                               = 441, // Automatic rgb_exposure/gain ROI Width
    CV_CAP_PROP_XI_AEAG_ROI_HEIGHT                              = 442, // Automatic rgb_exposure/gain ROI Height
...
enum
{
    ...
    CV_CAP_PROP_EXPOSUREPROGRAM           = 17009, // Camera rgb_exposure program.
